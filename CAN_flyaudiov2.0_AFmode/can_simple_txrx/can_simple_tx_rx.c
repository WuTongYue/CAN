...
void CAN_IRQHandler(void)
{
    ...
    {   //check is FullCAN interrupt occurs or not
                ...
                ||(CAN_FullCANPendGetStatus(LPC_CANAF,FULLCAN_IC1)))
        {
            ...
            FCAN_ReadObj(LPC_CANAF,(CAN_MSG_Type *)&RxMsgbuf[count]);
            count++;
        }
    }
